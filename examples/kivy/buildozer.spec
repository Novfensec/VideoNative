...
source.exclude_dirs = tests, bin, venv, android, windows, linux
...
requirements = python3, kivy==2.3.1, ffmpeg, videonative, pyjnius, android, https://github.com/CarbonKivy/CarbonKivy/archive/master.zip 
